    ...
    <div className='bg-[linear-gradient(-180deg,#f53d2d,#f63)] pb-5 pt-2 text-white'>
      <div className='container'>
          ...
          {!isAuthenticated && (
            <div className=''>
              <div className='flex items-center'>
                <Link to={path.register} className='mx-3 my-1 capitalize hover:text-white/70 '>
                  Đăng ký
                </Link>
                <div className='h-4 border-r-[1px] border-r-white/40'></div>
                <Link to={path.login} className='mx-3 my-1 capitalize hover:text-white/70 '>
                  Đăng nhập
                </Link>
              </div>
            </div>
        ...
        <div className='mt-4 grid grid-cols-12 items-end gap-4'>
          ...
          <form onSubmit={handleSubmitSearch} className='col-span-9'>
                    ...
                    <div className='p-2'>
                      ...
                      <div className='mt-5'>
                        {purchasesInCart.slice(0, MAX_PURCHASE).map((purchase) => (
                          <div key={purchase._id} className='mt-2 flex py-2 hover:bg-gray-200'>
                      ...
                      <div className='mt-6 flex items-center justify-between'>
                        <div className='text-xs capitalize text-gray-500'>
                          {purchasesInCart.length > MAX_PURCHASE ? purchasesInCart.length - MAX_PURCHASE : ''} Thêm hàng vào giỏ
                        </div>
